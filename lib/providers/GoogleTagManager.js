...
function () {
  ...
  _createClass(GoogleTagManager, [{
    ...
    value: function track(data) {
      ...
      var trackDelayedPageView = function trackDelayedPageView() {
        if (window.google_tag_manager && window.google_tag_manager.dataLayer && window.google_tag_manager.dataLayer.gtmLoad) {
          delayedPageview.map(function (delayedData) {
            return window.dataLayer.push(delayedData);
          });
        } else {
      ...
      window.addEventListener('load', trackDelayedPageView); // Tagging team requests that all initial gtm.view
    ...
    value: function createScriptDoc(reducerModules) {
      ...
      script.addEventListener('load', function () {
        return _this.onLoad(reducerModules);
      });
