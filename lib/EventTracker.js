...
exports.default = exports.VIEW_ACTION = undefined;
...
var EventTracker = (0, _emitter2.default)(_class = (0, _configurable2.default)(_class = function () {
  ...
  EventTracker.prototype.track = function track(action, props) {
  ...
  EventTracker.prototype.view = function view() {
    for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
      args[_key2] = arguments[_key2];
    }

    return this.track.apply(this, [VIEW_ACTION].concat(args));
  };

  EventTracker.prototype.include = function include(data) {
  ...
  EventTracker.prototype.debug = function debug() {
    if (arguments.length) this._debug = !!(arguments.length <= 0 ? undefined : arguments[0]);
    return this._debug;
  };

  EventTracker.prototype._process = function _process(data) {
    return (0, _sanitize2.default)(this._reduce(data));
  };

  EventTracker.prototype._reduce = function _reduce(data) {
    return this.reducers.reduce(function (obj, reducer) {
      return reducer.reduce(obj);
    }, data);
  };

  EventTracker.prototype._initModules = function _initModules() {
    var _this = this;
